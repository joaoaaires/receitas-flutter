...
const String dingbatBlock = r'\u2700-\u27BF';

const String nonChar = r'\x00-\x2F\x3A-\x40\x5B-\x60\x7b-\xBF\xD7\xF7';

const String geniralPunctuation = r'\u2000-\u206F';
...
class EnumToString {
  ...
  static String parseCamelCase(String enumItem) {
    if (enumItem == null) return null;
